...
export default {
  //props,data,computed中的数据vue会自动给他添加set，get，观测数据变化，做一个监听，主要是和dom做数据绑定
   created(){
this.touch={}//尽在函数内部使用，不要观察其变化
...
onShortcutTouchStart(e){
        let anchorIndex = getData(e.target, 'index')//是一个字符串
...
//console.log(this.$refs.listview.scrollToElement(this.$refs.listGroup[anchorIndex],0));
},
...
this.$refs.listview.scrollToElement(this.$refs.listGroup[index],0)//第二个参数是 是否需要缓动
},
